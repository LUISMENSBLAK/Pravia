...
import { timingPolicyConfigurationRoutes, timingSourceRoutes } from './routes/timingPolicy.routes';
...
app.use('/api/settings/catalogs', configurationCatalogRoutes);
app.use('/api/settings/timing-policies', timingPolicyConfigurationRoutes);
app.use('/api/timing', timingSourceRoutes);
