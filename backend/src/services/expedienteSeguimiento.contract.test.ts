...
const checks: Array<[string, () => boolean]> = [
  ...
  ['09 aplica por defecto false', () => service.includes("activity.aplica_por_defecto ? 'NO_INICIADO' : 'NO_APLICA'")],
  ...
  ['15 sin self dependency operacional', () => service.includes('prerequisiteId === activityId')],
