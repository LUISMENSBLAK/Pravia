...
const catchAsync = (handler: AsyncMiddleware) => async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const requireProspectoObjectAccess = catchAsync(async (req, res, next) => {
...
export const requireCotizacionObjectAccess = catchAsync(async (req, res, next) => {
...
export const requireComparecienteObjectAccess = catchAsync(async (req, res, next) => {
...
export const requireDocumentoObjectAccess = catchAsync(async (req, res, next) => {
...
export const requireAltaCargaObjectAccess = catchAsync(async (req, res, next) => {
