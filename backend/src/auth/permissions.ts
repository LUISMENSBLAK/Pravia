...
export const PERMISSIONS = [
  ...
  'reportes.read', 'reportes.global.read', 'reportes.financial.read', 'reportes.targets.manage',
  'ia.read', 'ia.execute',
  'ai.use', 'ai.prospectos.read', 'ai.expedientes.read', 'ai.comparecientes.read', 'ai.documentos.read',
  'ai.agenda.read', 'ai.finanzas.read', 'ai.reportes.read', 'ai.cumplimiento.read', 'ai.work.read',
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  ADMINISTRACION: [
    ...
    'agenda.read', 'agenda.write',
    'finanzas.read', 'finanzas.write', 'finanzas.validate',
    'reportes.read', 'reportes.global.read', 'reportes.financial.read', 'reportes.targets.manage', 'ia.read', 'ia.execute',
    'ai.use', 'ai.prospectos.read', 'ai.expedientes.read', 'ai.comparecientes.read', 'ai.documentos.read',
    'ai.agenda.read', 'ai.finanzas.read', 'ai.reportes.read', 'ai.cumplimiento.read', 'ai.work.read',
    'ai.search', 'ai.navigate', 'ai.actions.prepare', 'ai.admin.read',
  ...
  ABOGADO: [
    ...
    'documentos.read', 'documentos.write', 'documentos.unlink',
    'comparecientes.read', 'comparecientes.write',
    'notarias.read', 'agenda.read', 'agenda.write', 'reportes.read', 'reportes.financial.read',
    'ia.read', 'ia.execute',
    'ai.use', 'ai.prospectos.read', 'ai.expedientes.read', 'ai.comparecientes.read', 'ai.documentos.read',
    'ai.agenda.read', 'ai.reportes.read', 'ai.cumplimiento.read', 'ai.work.read', 'ai.search', 'ai.navigate', 'ai.actions.prepare',
    'cumplimiento.read', 'cumplimiento.write', 'cumplimiento.confirm',
    'usuarios.read',
  ],
  RECEPCION: [
  ...
  CONSULTA: [
    ...
    'ai.agenda.read', 'ai.reportes.read', 'ai.cumplimiento.read', 'ai.work.read', 'ai.search', 'ai.navigate',
  ],
};
