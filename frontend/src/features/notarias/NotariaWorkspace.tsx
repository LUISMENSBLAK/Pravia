...
export function NotariaWorkspace() {
  ...
  const goTab = (key: string) => navigate(`${location.pathname}#${key}`, { replace: true });
  useEffect(() => {
