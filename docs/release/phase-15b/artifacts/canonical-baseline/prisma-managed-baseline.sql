...
-- CreateIndex
CREATE UNIQUE INDEX "actividades_economicas_clave_key" ON "actividades_economicas"("clave" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "caracteres_compareciente_clave_key" ON "caracteres_compareciente"("clave" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "caracteres_representacion_clave_key" ON "caracteres_representacion"("clave" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_compareciente_actividad" ON "compareciente_actividades_economicas"("compareciente_id" ASC, "actividad_id" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_compareciente_doc" ON "compareciente_documentos"("compareciente_id" ASC, "documento_id" ASC, "categoria" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "compliance_evidence_review_id_documento_id_tipo_evidencia_key" ON "compliance_evidence"("review_id" ASC, "documento_id" ASC, "tipo_evidencia" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "compliance_rule_sets_tipo_clave_version_key" ON "compliance_rule_sets"("tipo" ASC, "clave" ASC, "version" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_expediente_compareciente_caracter" ON "expediente_comparecientes"("expediente_id" ASC, "compareciente_id" ASC, "caracter_id" ASC, "forma_comparecencia" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "personas_fisicas_compareciente_id_key" ON "personas_fisicas"("compareciente_id" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "personas_morales_compareciente_id_key" ON "personas_morales"("compareciente_id" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_tipo_acto_caracter" ON "tipo_acto_caracteres_compareciente"("tipo_acto_id" ASC, "caracter_id" ASC);
